...
const consoleOutputNode = {
  ...
  inputs: [{ name: 'input', type: 'any', required: true, description: 'Data to output to console' }],
  outputs: [{ name: 'output', type: 'object', description: 'Pass-through data with console metadata' }],
  properties: {
    logLevel: {
      type: 'select',
      default: 'info',
