...
6. Testing strategy`;
  ...
  getFallbackResponse(userMessage, context) {
    const fallbacks = {
      automation_expert: "I apologize, but I'm currently experiencing technical difficulties. However, I can suggest checking the FlowForge documentation or exploring similar workflows in our templates gallery.",
      node_designer: "I'm temporarily unable to access my knowledge base. Try starting with basic nodes like Manual Trigger, HTTP Request, and Set Variable for most workflows.",
      flow_architect: "I'm having connectivity issues. Consider breaking down your workflow into smaller, testable components and building incrementally."
    };

    return fallbacks[context] || "I'm currently experiencing technical difficulties. Please try again in a moment.";
  }
